...
namespace ChatNest.Services.Abstract
{
    ...
    public interface IMessageService
    {
        ...
        Task<(Dictionary<string, Dictionary<string, Dictionary<string, MessageDto>>>, List<string>)> SendMessageAsync(string userId, string chatId, string chatType, SendMessage dto);

        /// <summary>
        /// فوروارد کردن یک پیوست موجود به گفتگوی دیگر، بدون آپلود دوباره فایل.
        /// </summary>
        Task<(Dictionary<string, Dictionary<string, Dictionary<string, MessageDto>>>, List<string>)> ForwardAttachmentAsync(
            string userId,
        ...
        Task<(Dictionary<string, Dictionary<string, Dictionary<string, MessageDto>>>, List<string>)> DeleteMessageAsync(string userId, string chatType, string chatId, string messageId, byte deletionType);
        ...
        Task<(Dictionary<string, Dictionary<string, Dictionary<string, MessageDto>>>, List<string>)> DeliverOrReadMessageAsync(string userId, string chatType, string chatId, string messageId, string fieldName);
